...
// 2. Name Cases: Store a person’s name in a variable, and then print that person’s name in lowercase, uppercase, and titlecase.
   var Nname:string=" faheem ali saif ";
...
// Albert Einstein once said, “A person who never made a mistake never tried anything new.”
  ...
  var numbers:number[]=[5,3,13,2]
  var addition:number=numbers[0]+numbers[1];
  var subtraction:number=numbers[2]-numbers[0];
  var Multiplication:number=(numbers[0]*numbers[3])-numbers[3];
  var Division:number=(numbers[1]+numbers[2])/numbers[3];
...
`);
  ...
  for (let index = 0; index <=4; index++) {
    ...
    var  favoritre_No:Number=7;
    console.log(`My favorite no is ${favoritre_No}. `);
     //.10 Adding Comments: Choose two of the programs you’ve written, and add at least one comment to each. If you don’t have anything specific to write because your programs are too simple at this point, just add your name and the current date at the top of each program file. Then write one sentence describing what the program does.
    
     var numbers:number[]=[5,3,13,2]   //i use array for practce no to add and other operations
  var addition:number=numbers[0]+numbers[1];
  var subtraction:number=numbers[2]-numbers[0];
  var Multiplication:number=(numbers[0]*numbers[3])-numbers[3];
  var Division:number=(numbers[1]+numbers[2])/numbers[3];
...
//.11 Names: Store the names of a few of your friends in a array called names. Print each person’s name by accessing each element in the list, one at a time.
 ...
 var piaic_group:String[]=["Manan","Zafeer ","Ali Hamza","Anees","Faheem"];
...
//. 13 Your Own Array: Think of your favorite mode of transportation, such as a motorcycle or a car, and make a list that stores several examples. Use your list to print a series of statements about these items, such as “I would like to own a Honda motorcycle.”
 ...
 var vehicle:string[]=["Motorcycle","Car😍", "Cycle",];
...
var dinner_invite:string[]=["Noman", "Asim","Faheem"];
...
for (let index = 0; index < dinner_invite.length; index++) {
    if(dinner_invite[index]=="Faheem"){
        setTimeout(() => { // this timeout will give result of person what is not available and will print in end.
            console.log(`${dinner_invite[index]} I understand you are out of station So don't woory i will handle situation.`)
            dinner_invite.pop();
        }, 2000) 
...
// • Store the locations in a array. Make sure the array is not in alphabetical order.
  var LocName:string[]=["Iefel tower","Burj Khalifa" ,"Chinese Market","Dubai Market","New york city"]
...
let mountains:string[]=["karakaram","Himaliya","Hindokush"];
let rivers:string[]=["Ravi","chanab"];
let countries:string[]=["America","China","Dubai"];
let cities:string[]=["Lahore",'Islamabad'];
let languages:string[]=["Pujabi","sindhi"];
...
var favorite_fruits:string[]=["banana","Cherry","Lychee"]
...
var username:string[]=["admin","faheem","Manan","Zafeer","Ali hanmza"];
...
// • Otherwise, print a generic greeting, such as Hello Eric, thank you for logging in again.
if(username.length!=0){for (let index = 0; index <username.length; index++) {
...
var current_users:string[]=["admin","faheem","Manan","Zafeer","Ali hanmza"] 
// • Make another list of five usernames called new_users. Make sure one or two of the new usernames are also in the current_users list.

var new_users:string[]=["Hamza","asad","faheem","umer","Manan"];;
...
var ordinal:number[]=[1,2,3,4,5,6,7,8,9];
...
var pizza_name:string[]=["fajita","Tikka special","crown diagonal"]
...
function make_shirt(a:number,b:string){
...
function make_shirt(a:number,b:string){
  ...
  function descrbe_city(city:string,country:string="pakistan"){
...
//.41 Great Magicians: Start with a copy of your program from Exercise 39. Write a function called make_great() that modifies the array of magicians by adding the phrase the Great to each magician’s name. Call show_magicians() to see that the list has actually been modified.
  var magiciansName:string[]=["Faheem","zafeer","Manan"]
...
function show_magicians2(){
  ...
  console.log(`The original Array:     ${magiciansName}`);
   var newarr:string[]=magiciansName.map((a)=>  "The greate "+ a)
...
console.log("---------------------");
  ...
  function SandwichSummar(a:string[]){
  ...
  function set_data(a:string,b:string,...args:any){
